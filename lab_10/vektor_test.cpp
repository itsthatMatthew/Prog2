...
/// 1. feladat:
        ...
        /// Próbálja ki!
        cout << "it1 (for_each): ";
        std::for_each(it1, it1+10, ostreamFunctor<int>(std::cout, ", "));
		cout << endl;
#endif // ELKESZULT >= 1
        ...
        cout << "otos: ";
        std::for_each(otos.begin(), otos.end(), ostreamFunctor<int>(std::cout, ", "));
		cout << endl;
#endif // ELKESZULT >= 2
        ...
        cout << std::count_if(std::begin(it1), std::end(it1), negativ<double>());
		cout << endl;
#endif // ELKESZULT >= 6
        ...
        cout << std::count_if(darr.begin(), darr.end(), std::bind<double>(std::less<double>(), std::placeholders::_1, 100)); // c++17-es mo., fun fact: std::bind2nd nem elérhető VS-ben a MS szolgáltatott headeren keresztül a _HAS_AUTO_PTR_ETC makró definiálása nékül, de akkor ezt tegyük meg
		cout << endl;
#endif // ELKESZULT >= 8
